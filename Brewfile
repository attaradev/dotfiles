...
brew "mise"                         # Unified version manager for Node.js, Python, Go, Ruby, Java, Rust, etc.
                                    # Replaces nvm, pyenv, rbenv, goenv, jenv, rustup with a single fast tool
                                    # Configure via: scripts/setup-mise.sh
...
cask "coderabbit"                   # AI code review platform
...
cask "obsidian"                     # Personal knowledge management and note-taking app
