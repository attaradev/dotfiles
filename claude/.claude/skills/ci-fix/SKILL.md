...
- CI platform: !`[ -d ".github/workflows" ] && echo "GitHub Actions" || [ -f ".gitlab-ci.yml" ] && echo "GitLab CI" || [ -f ".circleci/config.yml" ] && echo "CircleCI" || [ -f "Jenkinsfile" ] && echo "Jenkins" || echo "(not detected)"`
