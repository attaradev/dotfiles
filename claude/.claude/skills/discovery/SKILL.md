...
Write questions in open-ended form. Screening questions may be yes/no (e.g., "Do you currently use X?"), but all exploratory questions must be open-ended — never ask users what they want, ask about their behaviour and past experiences.

State the minimum participant count (typically 5–8 for exploratory research). If targeting multiple personas, specify how many interviews per segment.
