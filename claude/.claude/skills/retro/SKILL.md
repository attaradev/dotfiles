...
If prior retro notes exist, surface incomplete action items at the start of the facilitation guide (5 min max). Do not let them dominate the current sprint's discussion.
