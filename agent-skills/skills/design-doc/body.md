...
Gather repository context before planning. Understand the existing system before designing additions to it.
...
- A design is ready for implementation when every item in Open Questions either has an answer or is explicitly deferred with an owner and timeline
