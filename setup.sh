...
write_optional_cask_env() {
  local entry suffix brew_var bundle_var
...
echo "   ${GREEN}DOTFILES_INSTALL_JAVA=1 make mise${NC} # Install optional Java 21"
echo "   ${GREEN}DOTFILES_INSTALL_RUST=1 make mise${NC} # Install optional Rust 1.93"
echo "   ${GREEN}DOTFILES_INSTALL_JAVA=1 DOTFILES_INSTALL_RUST=1 make mise${NC}"
echo ""
