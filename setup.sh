...
export BREW_INSTALL_ANTIGRAVITY=${BREW_INSTALL_ANTIGRAVITY:-0}
export HOMEBREW_BUNDLE_INSTALL_ANTIGRAVITY=${HOMEBREW_BUNDLE_INSTALL_ANTIGRAVITY:-${BREW_INSTALL_ANTIGRAVITY:-0}}
export BREW_INSTALL_VIRTUALBOX=${BREW_INSTALL_VIRTUALBOX:-0}
export HOMEBREW_BUNDLE_INSTALL_VIRTUALBOX=${HOMEBREW_BUNDLE_INSTALL_VIRTUALBOX:-${BREW_INSTALL_VIRTUALBOX:-0}}
export BREW_INSTALL_BRAVE_BROWSER=${BREW_INSTALL_BRAVE_BROWSER:-0}
export HOMEBREW_BUNDLE_INSTALL_BRAVE_BROWSER=${HOMEBREW_BUNDLE_INSTALL_BRAVE_BROWSER:-${BREW_INSTALL_BRAVE_BROWSER:-0}}
export BREW_INSTALL_VLC=${BREW_INSTALL_VLC:-0}
export HOMEBREW_BUNDLE_INSTALL_VLC=${HOMEBREW_BUNDLE_INSTALL_VLC:-${BREW_INSTALL_VLC:-0}}
export BREW_INSTALL_SPOTIFY=${BREW_INSTALL_SPOTIFY:-0}
export HOMEBREW_BUNDLE_INSTALL_SPOTIFY=${HOMEBREW_BUNDLE_INSTALL_SPOTIFY:-${BREW_INSTALL_SPOTIFY:-0}}
EOF
...
configure_optional_cask "BREW_INSTALL_ANTIGRAVITY" "Antigravity" "AI coding agent IDE"
